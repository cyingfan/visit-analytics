...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/"),e.state("overview",{url:"/",templateUrl:"templates/dashboard.html"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("average",{url:"/average",templateUrl:"templates/average.html"}).state("percentage",{url:"/percentage",templateUrl:"templates/percentage.html"})}]);
...
angular.module("RDash").controller("AverageCtrl",["$scope",function(e){var a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],t={title:{text:""},options:{xAxis:{categories:[]},yAxis:{title:{text:"Visits"},plotLines:[{value:0,width:1,color:"#404040"}]},legend:{enabled:!1},plotOptions:{line:{dataLabels:{enabled:!0}}}},series:[{name:"",data:[]}]};e.periodType="day",e.loadGraph=function(){"day"==e.periodType?(t.title.text="Average By Weekday",t.options.xAxis.categories=a,t.series[0].name="byWeekDay",t.series[0].data=e.rawData.avg_days):"hour"==e.periodType&&(t.title.text="Average By Hour",t.options.xAxis.categories=e.rawData.avg_hours.keys(),t.series[0].name="byHour",t.series[0].data=e.rawData.avg_hours)},e.highChartsNg=t,e.loadGraph()}]);
function MasterCtrl(t,e,o){var g=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(o){t.toggle=o>=g?angular.isDefined(e.get("toggle"))?e.get("toggle")?!0:!1:!0:!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()},o.get("data/WebDeveloperRecrData.json").success(function(e){t.rawData=e})}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","$http",MasterCtrl]);
...
angular.module("RDash").controller("PercentageCtrl",["$scope","$filter",function(a,e){var t={title:{text:""},options:{chart:{type:"bar"},xAxis:{categories:[]},yAxis:{max:100,title:{text:"Percent",align:"high"},labels:{overflow:"justify"}},tooltip:{valueSuffix:" %"},legend:{layout:"vertical",align:"right",verticalAlign:"top",floating:!0,borderWidth:1,backgroundColor:Highcharts.theme&&Highcharts.theme.legendBackgroundColor||"#FFFFFF",shadow:!0},plotOptions:{bar:{dataLabels:{enabled:!0,format:"{y} %"}}}},series:[]},r=function(a){for(var t=a.split("_"),i="",r=1;r<t.length;r++)i=i.concat(" ",e("capitalize")(t[r]));return i},o=["percent_qualified_visits","percent_engaged_visits","percent_visits_potential"],s={name:"",data:[],id:""};a.viewBy="types",a.loadGraph=function(){if("types"==a.viewBy){t.title.text="By Types";var e={},n=[];for(i in o){var l=o[i];n.push(r(l));for(j in a.rawData["subloc_"+l])data=a.rawData["subloc_"+l][j],name=r(data[0]),e[name]||(e[name]=[]),e[name].push(data[1])}}else if("subloc"==a.viewBy){t.title.text="By Sub Location";var e={},n=[];for(i in o){var l=o[i],c=r(l);for(j in a.rawData["subloc_"+l])data=a.rawData["subloc_"+l][j],name=r(data[0]),-1==n.indexOf(name)&&n.push(name),e[c]||(e[c]=[]),e[c].push(data[1])}}series=[],angular.forEach(e,function(a,e){var t=angular.copy(s);t.name=e,t.id=e,t.data=a,this.push(t)},series),console.log(angular.toJson(series)),t.series=series,t.options.xAxis.categories=n},a.highChartsNg=t,a.loadGraph()}]);